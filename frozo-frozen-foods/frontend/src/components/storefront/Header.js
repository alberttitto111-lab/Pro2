// frontend/src/components/storefront/Header.js

import React, { useContext, useState } from 'react'; // Add useState to imports
import {
  AppBar,
  Toolbar,
  Typography,
    ...
    <AppBar position="sticky" sx={{ bgcolor: 'white', color: 'text.primary', boxShadow: 1 }}>
      <Container maxWidth="xl">
        <Toolbar sx={{
          ...
          {/* Mobile View - Menu Button and Cart/Wishlist */}
          <Box sx={{
